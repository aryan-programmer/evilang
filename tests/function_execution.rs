...
"#,
		vec![PrimitiveValue::integer(4), PrimitiveValue::integer(9)]
	);
}
...
"#,
		vec![PrimitiveValue::integer(40), PrimitiveValue::integer(51)]
	);
}
...
"#,
		vec![PrimitiveValue::integer(2432902008176640000)]
	);
}
...
push_res_stack(func(30));
"#,
		vec![PrimitiveValue::integer(160), PrimitiveValue::integer(165), PrimitiveValue::integer(-40)]
	);
}
...
push_res_stack(getX());
"#,
		vec![PrimitiveValue::integer(10), PrimitiveValue::integer(42), PrimitiveValue::integer(-13)]
	);
}
...
trigger(7, 9);
"#,
		vec![PrimitiveValue::integer(30), PrimitiveValue::integer(42)]
	);
}
...
"#,
		vec![PrimitiveValue::integer(100), PrimitiveValue::integer(144)]
	);
}

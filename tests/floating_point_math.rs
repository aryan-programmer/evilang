...
fn addition() -> TestRes {
	ensure_program_statement_results(
		...
		vec![PrimitiveValue::float(0.1 + 0.2)]
	);
}
...
fn addition_and_subtraction() -> TestRes {
	ensure_program_statement_results(
		...
		vec![PrimitiveValue::float(0.1 + 0.2 - 0.3)]
	);
}
...
fn multiplication() -> TestRes {
	ensure_program_statement_results(
		...
		vec![PrimitiveValue::float(0.2 * 0.3)]
	);
}
...
fn multiplication_2() -> TestRes {
	ensure_program_statement_results(
		...
		vec![PrimitiveValue::float(0.2 * 0.3 * 0.4)]
	);
}
...
fn addition_and_multiplication() -> TestRes {
	...
	ensure_program_statement_results(
		...
		vec![PrimitiveValue::float(0.2 + 0.3 * 0.4 + 0.5)]
	);
}
